...
public class ElasticDocumentController {
    ...
    getDocumentById(@PathVariable @NotEmpty String id) {
        ...
        logger.debug("Elasticsearch returned document with id {} on port {}", id, port);
    ...
    getDocumentByText(@RequestBody @Valid ElasticQueryServiceRequestModel elasticQueryServiceRequestModel,
        ...
        logger.info("User {} querying documents for text {}", principal.getUsername(),
        ...
        logger.info("Elasticsearch returned {} of documents on port {}", response.getQueryResponseModels().size(), port);
        return ResponseEntity.ok(response);
    }
