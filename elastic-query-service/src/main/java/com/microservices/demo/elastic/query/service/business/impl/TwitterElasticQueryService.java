...
import com.microservices.demo.elastic.query.client.services.ElasticQueryClient;
    ...
    private ElasticQueryServiceWordCountResponseModel retrieveResponseModel(String text,
        ...
        return webClientBuilder
                ...
                .onStatus(
                        ...
                        clientResponse -> clientResponse.bodyToMono(String.class).flatMap(error -> Mono.just(new ElasticQueryServiceException(error))))
                .onStatus(
